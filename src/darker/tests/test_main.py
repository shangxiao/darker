...
from darker.__main__ import WorkTreeFileAccess
...
def test_format_edited_parts_empty():
    with pytest.raises(ValueError):
        darker.__main__.format_edited_parts(False, {}, True, WorkTreeFileAccess(set()))
...
def test_format_edited_parts(
    ...
    darker.__main__.format_edited_parts(
        isort, black_args, print_diff, WorkTreeFileAccess({Path('a.py')})
    )
